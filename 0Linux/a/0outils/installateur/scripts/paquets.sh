...
if [ "${SETUPROOT}" = "" ]; then
	...
	echo ""
	echo "Pour lister tous les paquets disponibles (plus de 1500 !), tapez : "
	echo "	0g -i"
	echo "Suivi d'un nom de paquet, il vous en affichera une brève description :"
	echo "	0g -i vlc"
	echo "Pour installer par exemple GIMP, le navigateur Firefox et le lecteur VLC :"
	echo "	0g gimp firefox vlc"
	echo "Enfin, vous pouvez mettre à jour tout votre système avec un simple :"
	echo "	0g"
	echo ""
